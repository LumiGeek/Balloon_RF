...
unsigned char nrf24l01_write_tx_payload_noack(unsigned char * data, unsigned int len, bool transmit)
{
	unsigned char status;
	
	status = nrf24l01_execute_command(nrf24l01_W_TX_PAYLOAD_NOACK, data, len, false);
