...
#define MY_DEFAULT_NETWORK_TYPE             CFG_WF_ADHOC  /* CFG_WF_INFRASTRUCTURE, CFG_WF_ADHOC, CFG_WF_P2P */ 
...
#define MY_DEFAULT_LIST_RETRY_COUNT         3
    ...
    #define MY_DEFAULT_SSID_NAME                "BalloonXmit_II"           /* if WF_SECURITY_WPS_PUSH_BUTTON must be "" (empty string) */   
