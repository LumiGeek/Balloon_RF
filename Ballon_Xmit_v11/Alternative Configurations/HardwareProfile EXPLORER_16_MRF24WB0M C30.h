...
//		_CONFIG2(FNOSC_PRIPLL & OSCIOFNC_ON & POSCMOD_EC)  //ext oscillator
		_CONFIG2(FNOSC_FRCPLL & OSCIOFNC_ON &POSCMOD_NONE) //int oscillator
...
// LEDs
#define LED0_TRIS			(TRISBbits.TRISB8)	// Wifi LED
#define LED0_IO				(LATBbits.LATB8)
#define LED1_TRIS			(TRISCbits.TRISC3)	// Nordic LED
#define LED1_IO				(LATCbits.LATC3)
...
#define NRF_
//NORDIC chip defines
	#define NRF_SSPBUF			(SPI2BUF)
	#define NRF_SPISTAT			(SPI2STAT)
	#define NRF_SPISTATbits		(SPI2STATbits)
	#define NRF_SPICON1			(SPI2CON1)
	#define NRF_SPICON1bits		(SPI2CON1bits)
	#define NRF_SPICON2			(SPI2CON2)
	#define NRF_SPI_IE			(IEC2bits.SPI2IE)
//	#define WF_SPI_IP			(IPC2bits.SPI1IP)
	#define NRF_SPI_IF			(IFS2bits.SPI2IF)

	#define NRF_CSN_TRIS			(TRISAbits.TRISA4)
	#define NRF_CSN_IO			(LATAbits.LATA4)
	#define NRF_CE_TRIS			(TRISAbits.TRISA9)
	#define NRF_CE_IO			(LATAbits.LATA9)
	#define NRF_SDI_TRIS			(TRISBbits.TRISB3)
	#define NRF_SCK_TRIS			(TRISBbits.TRISB4)
	#define NRF_SDO_TRIS			(TRISCbits.TRISC0)

	#define NRF_INT_TRIS	    (TRISBbits.TRISB2)  // INT1
	#define NRF_INT_IO		(PORTBbits.RB2)
...
//----------------------------
	...
	#define WF_SDI_TRIS			(TRISCbits.TRISC6)
	#define WF_SCK_TRIS			(TRISCbits.TRISC8)
	#define WF_SDO_TRIS			(TRISBbits.TRISB11)
	#define WF_RESET_TRIS		(TRISBbits.TRISB9)
	#define WF_RESET_IO			(LATBbits.LATB9)

		#define WF_INT_TRIS	    (TRISCbits.TRISC7)  // INT1
		#define WF_INT_IO		(PORTCbits.RC7)

	#define WF_HIBERNATE_TRIS	(TRISBbits.TRISB13)
	#define	WF_HIBERNATE_IO		(PORTBbits.RB13)
