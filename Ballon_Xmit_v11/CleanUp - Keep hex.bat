...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - TCPIP WiFi EasyConfig Demo App - C18 - PICDEMNET2_MRF24WB0M" /s /q
rmdir "Objects - TCPIP WiFi EasyConfig Demo App - C30 - EXPLORER_16_MRF24WB0M" /s /q
rmdir "Objects - TCPIP WiFi EasyConfig Demo App - C30 - PIC24FJ256DA210_DEV_BOARD_MRF24WB0M" /s /q
rmdir "Objects - TCPIP WiFi EasyConfig Demo App - C32 - EXPLORER_16_MRF24WB0M" /s /q
